...
(
    ...
    ADMIN_ID         VARCHAR2(20)     DEFAULT 'ADMIN'   NULL, 
    FILE_IMG_NAME    VARCHAR2(20)     NULL, 
    ORI_IMG_NAME     VARCHAR2(20)     NULL, 
    HIT              NUMBER(5, 0)     DEFAULT 1   NOT NULL, 
...
(
    ...
    SELLING_DATE    VARCHAR2(20)      DEFAULT SYSDATE   NULL, 
...
(
    ...
    R_STATUS       VARCHAR2(20)      DEFAULT '등록대기'   NULL, 
